...
private class ComposeableBackNavigationHandler(enabled: Boolean) : OnBackPressedCallback(enabled) {
...
internal fun ComposableHandler(
    ...
    val handler = remember { ComposeableBackNavigationHandler(enabled) }
